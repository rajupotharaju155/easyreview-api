...
import {
  ...
  EASY_STORY_PLAN_FEATURES,
  EASY_PROFILE_PLAN_FEATURES,
  planFeature,
  type PlanFeature,
} from './plan-feature';
...
export const PLAN_CODES = {
  ...
  EASY_STORY_STARTER: 'easy_story_starter',
  EASY_STORY_GROWTH: 'easy_story_growth',
  EASY_STORY_PRO: 'easy_story_pro',
  EASY_PROFILE_STARTER: 'easy_profile_starter',
  EASY_PROFILE_GROWTH: 'easy_profile_growth',
  EASY_PROFILE_PRO: 'easy_profile_pro',
} as const;
...
export const DEFAULT_PLANS: PlanSeed[] = [
  ...
  {
    code: PLAN_CODES.EASY_STORY_STARTER,
    name: 'EasyStory Starter',
    product: Product.EASY_STORY,
    amount: 399,
    currency: 'INR',
    usdAmount: 0,
    durationDays: 30,
    isActive: true,
    sortOrder: 21,
    features: EASY_STORY_PLAN_FEATURES,
  },
  {
    code: PLAN_CODES.EASY_STORY_GROWTH,
    name: 'EasyStory Growth',
    product: Product.EASY_STORY,
    amount: 1999,
    currency: 'INR',
    usdAmount: 0,
  ...
  {
    code: PLAN_CODES.EASY_STORY_PRO,
    name: 'EasyStory Pro',
    product: Product.EASY_STORY,
    amount: 3499,
    currency: 'INR',
  ...
  {
    code: PLAN_CODES.EASY_PROFILE_STARTER,
    name: 'EasyProfile Starter',
    ...
    isActive: true,
    sortOrder: 31,
    features: EASY_PROFILE_PLAN_FEATURES,
  },
  {
    code: PLAN_CODES.EASY_PROFILE_GROWTH,
    name: 'EasyProfile Growth',
    product: Product.EASY_PROFILE,
    amount: 1999,
    currency: 'INR',
    usdAmount: 0,
  ...
  {
    code: PLAN_CODES.EASY_PROFILE_PRO,
    name: 'EasyProfile Pro',
    product: Product.EASY_PROFILE,
    amount: 3499,
    currency: 'INR',
    usdAmount: 0,
